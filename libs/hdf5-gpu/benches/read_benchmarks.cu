...
static const char* WRITE_TEST_FILE = "libs/hdf5-gpu/benches/data/bench_write_copy.h5";
...
void debug_create_group() {
    ...
    std::filesystem::copy_file(
        bench_utils::BENCH_DATA_FILE,
        "libs/hdf5-gpu/benches/data/create_group_test.h5",
        std::filesystem::copy_options::overwrite_existing
    );
    ...
    strcpy(h_filepath, "libs/hdf5-gpu/benches/data/create_group_test.h5");
